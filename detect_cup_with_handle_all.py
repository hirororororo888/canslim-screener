"""
カップウィズハンドル検出・全銘柄版（sp500_tickers.json の "all" 1519銘柄対象、単発）
screening_results.json は触らない。detect_cup_with_handle.py と同じロジック。
"""
...
print(f"対象: {len(TICKERS)} 銘柄（全銘柄・カップウィズハンドル検出）")
