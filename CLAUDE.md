...
## 現在の市場状態（最終更新: 2026-07-25、重要な悪化あり）
- REDFORD: **Market in Correction相当へ悪化**（REPORTS-1740で「マーケットは下落調整段階に入った」と明言、REPORTS-1744で結論「現金化を急げ！」）
- IBD推奨の現物株保有比率: 従来40-60% → **0-20%に引き下げ**（現金保有率80-100%を推奨）
- ナスダック総合は25,000ポイント台・6月9日安値を下回って引け、ダイバージェンス（Nasdaq/ラッセル2000安・ダウ高=機関投資家の退避行動）が発生
- リーディング銘柄（メモリー半導体MU・SNDK等）の下落が先行 = 「炭鉱のカナリア」、通常NYSE全体の下落に1〜3週間先行する現象とREDFORDが警告
- 半導体・メモリ株が大幅安（SNDK -10.79%、NBIS -15.02%、AMAT -4.72%、INTC -7.89%等）。一方LLYは2連騰でベースパターン形成中
- 損切りルール再確認: 買値から-7〜8%で機械的に損切り、ナンピン買い・ファンダメンタルズ優秀論での安易な保有継続は厳禁とREDFORDが強調
- 最新レポート: REPORTS-1740〜1744（7/24-25）。Watch listにサイバーセキュリティ・グループ(CRWD/PANW/FTNT/RBRK/CYBR)とEW(Edwards Lifesciences)を追加
- REDFORDは7/28〜8/1旅行のため投稿休止予定。今後は毎日更新でなく不定期掲載に変更
- Minervini: 売買アクションなし（$LLY追加 2026-06-27が最後）。直近投稿はマインドセット系・宣伝のみ、新規言及なし
- 推奨ポジション: **キャッシュ最優先（80-100%）・新規個別株購入は見送り**
