...
## 現在の市場状態（最終更新: 2026-09-06）
- **【最重要】REDFORD REPORTS-1932（9/5 18:05、単独・注意喚起）: Up trend under pressure継続を再確認し、新規購入は慎重に・ポートフォリオに20-40%のキャッシュを残すよう推奨**（9/4改訂版の数値上のポジション60-80%と併せて読む）。決算発表が近い銘柄への注意も喚起。**MU（マイクロン）・SNDK（サンディスク）は急反発中だがチャートに大きなダメージが残っており「上値の供給リスク」があるため『綺麗なチャートを鑑賞する会』から除外中**——購入するならタイミングに細心の注意が必要とREDFORD自身が明言。9月アノマリー（9月第3週・中間選挙年が特に悪い）を改めて警告。**重要指標日程: 米8月PPI＝9/10 21:30、米8月CPI＝9/11 21:30（いずれも日本時間）**、この前後はボラティリティ増大に要警戒
...
- **IBD推奨の現物株保有比率は8/4の20-40%→8/8の60-80%→8/14のConfirmed Uptrend宣言後は80-100%まで引き上げ→8/19のUp trend under pressure格下げで60-80%→8/21にさらに40-60%まで引き下げ→9/1に60-80%へ一時引き上げ→9/3に40-60%へ再び引き下げ（Put/Call Ratio 0.95まで急悪化）→9/4に60-80%へ回復（Put/Call Ratio 0.84に改善）。短期間で頻繁に上下しており、市場の方向感が定まらない不安定な局面**
...
- 推奨ポジション: **9/6時点でUp trend under pressure継続中。9/4に急改善したPut/Call Ratio(0.84)・推奨現物株比率(60-80%)は維持されているが、9/5にREDFORD自身が「新規購入は慎重に、20-40%のキャッシュを残せ」と改めて注意喚起しており、数値上の改善を額面通り受け取らないことが重要**。9月第3週・中間選挙年の季節性リスクに加え、9/10 PPI・9/11 CPIという指数変動要因が控えており、この前後は特に警戒。既存ポジション（LPG等）は損切りライン厳守を最優先。エネルギーセクター（SLB・RNR等の突破銘柄、原油底入れ）は複数ソースで独立に浮上しており注視継続。**MU・SNDKはREDFORD自身が「上値の供給リスクがあり購入タイミングに要注意」と明言した銘柄——50日線待ちの方針を継続し、飛びつき買いは避ける**。ウォッチ候補: LLY（最優先・4層確証、8/20エントリー突破）、DELL・PLTR（REDFORD本人実買付、DELLは200日線2倍の除外シグナル発動中につき新規非推奨）、MU・SNDK（上値供給リスクにつき50日線待ち）、CRDO・ETON（8/18新規・急騰中）、FCX・EOG（8/21新規エントリー突破）、SLB・UBS・RNR（エントリー突破）、SNOW（9/4決算急騰・保有なし）、$SPCX（Minerviniウォッチ・ブレイクアウト確認）、GE/NMM/VIK/NTAP
